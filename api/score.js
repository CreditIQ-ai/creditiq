export default async function handler(req, res) {
  ...
  const prompt = `You are a senior credit analyst AI for an Indian SME lending platform. Analyse this business and return ONLY a valid JSON object with no markdown, no extra text, no explanation outside the JSON.
...
Return exactly this JSON structure:
{
  ...
  "summary": "<2-3 sentence plain English verdict for a lender>"
}`;
